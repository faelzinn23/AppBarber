...
const CadastraProduto = ({navigation}) => {
  ...
  const cadastrar = async () => {
    if (!descricao  || !nome   || !preco   ){
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({ nome:nome,descricao:descricao, preco : preco , imagem : imagem})
    };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={stilo.titulo}>Cadastrar Produto</Text>
